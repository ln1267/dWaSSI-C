...
! Grid numbers
      ...
      PARAMETER (MAX_GRIDS=10108,MAX_YEARS=100,MAX_HUCS=20)	 
! WUE
...
! CELLINFO
      REAL LATUDE,LONGI,HUCELE,HUCAREA,LADUSE_lc ! LADUSE is the ratio for each vegetation type
      INTEGER HUCNO,LADUSE
      COMMON/CELLINFO/LADUSE(MAX_GRIDS),LADUSE_lc(MAX_GRIDS,MAX_HUCS),&
			HUCNO(MAX_GRIDS),LATUDE(MAX_GRIDS),LONGI(MAX_GRIDS),HUCELE(MAX_GRIDS),HUCAREA(MAX_GRIDS)
...
! Soil Mositure (AV-average,EM-end of month)
       REAL AVSMC,AVUZTWC,AVUZFWC,AVLZTWC,AVLZFPC,AVLZFSC,EMSMC,EMUZTWC,EMUZFWC,EMLZTWC,EMLZFPC,EMLZFSC,SMC
...
! CARBON
        REAL GEPM,RECOM,NEEM,GEPA,NEEA,AHUCGEP, AHUCNEE,AHUCRE,ANGEP,ANRECO, ANNEE
		INTEGER NUM_YEAR_C
	  ...
	  ,ANGEP(MAX_GRIDS,MAX_YEARS),ANRECO(MAX_GRIDS,MAX_YEARS), ANNEE(MAX_GRIDS,MAX_YEARS)
